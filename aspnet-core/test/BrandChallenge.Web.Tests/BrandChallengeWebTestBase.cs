...
{
    public abstract class BrandChallengeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BrandChallengeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BrandChallengeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BrandChallengeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BrandChallengeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BrandChallengeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BrandChallengeDbContext, Task<T>> func)
        {
            T result;
